...
class MakeRDFLibGraph(beam.DoFn):
    ...
    def process(self, element, to_write_bucket_nm):
        ...
        g.add((pub_uri, aa.turtleFile,
               Literal(turtle_file_name, datatype=XSD.string)))
