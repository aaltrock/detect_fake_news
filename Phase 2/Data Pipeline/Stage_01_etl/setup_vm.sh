...
3sudo bash -c 'echo "exec /etc/X11/Xsession /usr/bin/gnome-session" > /etc/chrome-remote-desktop-session'
#sudo systemctl disable lightdm.service
#wget https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.de#b
